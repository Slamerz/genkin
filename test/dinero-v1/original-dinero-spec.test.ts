...
describe('Dinero v1 Original Dinero Spec tests', () => {
    describe('instantiation', () => {
      it('should return a new Dinero object when arguments are valid', () => {
        expect(Dinero({ amount: 500 })).toBeTruthy()
        expect(Dinero({ precision: 2 })).toBeTruthy()
      })
      it('should throw when amount is a float', () => {
        expect(() => Dinero({ amount: 0.1 })).toThrow()
      })
      it('should throw when amount is a string', () => {
        // @ts-expect-error - amount is a string for testing
        expect(() => Dinero({ amount: '100' })).toThrow()
      })
      it('should throw when precision is a float', () => {
        expect(() => Dinero({ precision: 0.5 })).toThrow()
      })
      it('should throw when precision is a string', () => {
        // @ts-expect-error - precision is a string for testing
    ...
    describe('#getPrecision', () => {
      it('should return the right precision as a number', () => {
        expect(Dinero({ precision: 3 }).getPrecision()).toBe(3)
      })
      it('should return the default precision as a number when no precision is specified', () => {
        expect(Dinero().getPrecision()).toBe(2)
      })
    })
    describe('#convertPrecision', () => {
      it('should return a new Dinero object with a new precision and a converted amount', () => {
        expect(
      ...
      it('should return a new Dinero object with a new precision and a converted rounded amount', () => {
        expect(
      ...
      it('should throw when new precision is invalid', () => {
        expect(() =>
          Dinero({ amount: 500, precision: 2 })
      ...
      it('should convert between precisions correctly', () => {
        expect(
      ...
      it('should convert from long initial precisions correctly', () => {
        expect(
      ...
      it('should convert from larger precisions with rounding correctly', () => {
        expect(
    ...
    describe('#add', () => {
      ...
      it('should throw when currencies are different', () => {
        expect(() =>
      ...
      it('should convert before adding when precisions are different', () => {
        expect(
          Dinero({ amount: 400 })
    ...
    describe('#subtract', () => {
      ...
      it('should convert before subtracting when precisions are different', () => {
        expect(
    ...
    describe('#multiply', () => {
      ...
      it('should return a new Dinero object with an amount multiplied and rounded down', () => {
        expect(
          Dinero({ amount: 400 })
            .multiply(2.001)
            .toObject()
      ...
      it('should return a new Dinero object with an amount multiplied and rounded up', () => {
        expect(
          Dinero({ amount: 400 })
            .multiply(2.002)
            .toObject()
    ...
    describe('#divide', () => {
      ...
      it('should return a new Dinero object with an amount divided and rounded down', () => {
        expect(
          Dinero({ amount: 400 })
            .divide(3)
            .toObject()
      ...
      it('should return a new Dinero object with an amount divided and rounded up', () => {
        expect(
          Dinero({ amount: 400 })
            .divide(6)
            .toObject()
      ...
      it('should return a new Dinero object with an amount divided and rounded to nearest even number', () => {
        expect(
          Dinero({ amount: 105 })
            .divide(2)
            .toObject()
    ...
    describe('#percentage', () => {
      ...
      it('should respect roundingMode', () => {
        expect(
          Dinero({ amount: 57 })
      ...
      it('should throw when percentage is out of range', () => {
        expect(() => Dinero({ amount: 500 }).percentage(101)).toThrow()
      })
    })
    describe('#allocate', () => {
      it('should allocate the amount of the Dinero object into new ones and distribute the remainder when given percentages', () => {
        const shares = Dinero({ amount: 1003 }).allocate([50, 50])
        expect(shares.map(share => share.getAmount())).toEqual([502, 501])
      })
      it('should allocate the amount of the Dinero object into new ones and distribute the remainder when given ratios', () => {
        const shares = Dinero({ amount: 100 }).allocate([1, 3])
        expect(shares.map(share => share.getAmount())).toEqual([25, 75])
      })
      it('should not distribute the remainder to zero ratios', () => {
        const shares = Dinero({ amount: 1003 }).allocate([0, 50, 50])
        expect(shares.map(share => share.getAmount())).toEqual([0, 502, 501])
      })
      it('should throw when all ratios are equal to zero', () => {
        expect(() => Dinero({ amount: 1003 }).allocate([0, 0])).toThrow()
      })
      it('should throw when one of the ratios is negative', () => {
        expect(() => Dinero({ amount: 1003 }).allocate([-50, -50])).toThrow()
      })
      it('should throw when array of ratios is empty', () => {
        expect(() => Dinero({ amount: 1003 }).allocate([])).toThrow()
      })
      it('should throw when one of ratios is not number', () => {
        expect(() => Dinero({ amount: 100 }).allocate([2, '98' as any])).toThrow()
      })
      it('should throw when one of ratios is Infinity', () => {
        expect(() => Dinero({ amount: 1000 }).allocate([0, Infinity])).toThrow()
      })
      it('should throw when one of ratios is NaN', () => {
        expect(() => Dinero({ amount: 1000 }).allocate([0, NaN])).toThrow()
      })
    })
    describe('#convert', () => {
      it('should return a new converted Dinero object when passed a promise instead of an API endpoint', async () => {
      ...
      it('should return a new converted Dinero object with the globally set property path', async () => {
      ...
      it('should return a new converted Dinero object with the locally set property path event if a property path was set globally', async () => {
        Dinero.globalExchangeRatesApi.propertyPath = 'data.rates.{{to}}'
        const res = await Dinero({ amount: 500 }).convert('EUR', {
          endpoint: new Promise(resolve =>
            resolve({
      ...
      it('should throw when destination currency is not valid', async () => {
    ...
    describe('#equalsTo()', () => {
      ...
      it('should return true when both amounts are equal once converted', () => {
        expect(
      ...
      it('should return false when both amounts are not equal once converted', () => {
        expect(
    ...
    describe('#lessThan', () => {
      ...
      it('should return true when amount is less than other amount once normalized', () => {
        expect(
          Dinero({ amount: 5000, precision: 3 }).lessThan(Dinero({ amount: 800 }))
        ).toBe(true)
      })
      it('should return false when amount is greater than other amount once normalized', () => {
        expect(
    ...
    describe('#lessThanOrEqual', () => {
      ...
      it('should return true when amount is equal to other amount once normalized', () => {
        expect(
          Dinero({ amount: 5000, precision: 3 }).lessThanOrEqual(
            Dinero({ amount: 500 })
          )
    ...
    describe('#greaterThan', () => {
      ...
      it('should return true when amount is greater than other amount once normalized', () => {
        expect(
      ...
      it('should return false when amount is less than other amount once normalized', () => {
        expect(
    ...
    describe('#hasSubUnits', () => {
      ...
      it('should return false when amount is a multiple of 10 to the power of precision', () => {
        expect(Dinero({ amount: 110000, precision: 4 }).hasSubUnits()).toBe(false)
      })
      it('should return true when amount is not a multiple of 100', () => {
        expect(Dinero({ amount: 1150 }).hasSubUnits()).toBe(true)
      })
      it('should return true when amount is not a multiple of 10 to the power of precision', () => {
    ...
    describe('#toUnit', () => {
      ...
      it('should return the amount divided by 10 to the power of precision', () => {
    ...
    describe('#toRoundedUnit', () => {
      ...
      it('should return the negative amount divided by 100, rounded to one fraction digit', () => {
        expect(Dinero({ amount: -1055 }).toRoundedUnit(1)).toBe(-10.6)
      })
      it('should return the amount divided by 100, rounded to two fraction digits', () => {
        expect(Dinero({ amount: 1055 }).toRoundedUnit(2)).toBe(10.55)
      })
      it('should return the amount divided by 100, rounded to no fraction digits', () => {
    ...
    describe('#toJSON', () => {
      it('should return the same object as #toObject', () => {
        const price = Dinero({ amount: 500, currency: 'EUR', precision: 2 })
        expect(price.toJSON()).toEqual(price.toObject())
      })
      it('should make Dinero objects stable when using JSON.parse after JSON.stringify', () => {
        const price = Dinero({ amount: 500, currency: 'EUR', precision: 2 })
    ...
    describe('#normalizePrecision', () => {
      it('should return an array of Dinero objects with normalized precision and converted amount', () => {
    ...
    describe('#minimum', () => {
      it('should return the smallest Dinero from an array of Dinero objects', () => {
      ...
      it('should return the smallest Dinero from an array of Dinero objects with different precisions', () => {
    ...
    describe('#maximum', () => {
      it('should return the biggest Dinero from an array of Dinero objects', () => {
      ...
      it('should return the biggest Dinero from an array of Dinero objects, with different precisions', () => {
