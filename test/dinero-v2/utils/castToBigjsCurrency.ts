...
export function castToBigjsCurrency(currency: CurrencyWithPrecisionOrExponent): Currency<Big> {
  ...
  return {
    ...
    base: Array.isArray(currency.base)
      ...
      : new Big((currency.base as number) ?? 10),
    exponent: new Big(exponentValue),
  };
}
