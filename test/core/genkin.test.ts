...
describe('Genkin Core', () => {
  ...
  const XYZ = createCurrency({ code: 'XYZ', numeric: 999, precision: 2, symbol: 'XYZ', name: 'Test Currency' });
  ...
  describe('Construction', () => {
    ...
    it('should create a Genkin instance with custom currency', () => {
      const money = genkin(10.50, { currency: EUR });
  ...
  describe('Properties', () => {
    ...
    describe('Dinero.js comparison', () => {
      ...
      it('should match Dinero.js zero precision currencies', () => {
        ...
        const dineroJPY = dinero({ amount: 1000, currency: USD_DINERO, scale: 0 });
